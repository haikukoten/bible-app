...
// Mapping of book names to abbreviations (applies across versions)
...
// List of books with abbreviations and chapter counts
export const books = [
...
// List of Bible versions referencing the shared book structure
export const bibleVersions = [
  {
    language: "Arabic",
    versions: [
      {
        name: "The Arabic Bible",
        abbreviation: "ar_svd",
        books: books,  // Reference the shared books array
      },
    ],
  },
  {
  ...
  },
  {
    ...
    versions: [
      ...
      {
        name: "Almeida Corrigida e Revisada Fiel",
        abbreviation: "pt_acf",
        books: books,  // Reference the shared books array
      },
      {
